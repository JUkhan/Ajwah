import { EFFECT_METADATA_KEY } from './effect';
import { STATE_METADATA_KEY } from './state';
...
export function setActionsAndEffects(target, includeStates = true) {
    ...
    Object.getOwnPropertyNames(target).forEach(prop => {
        ...
        if (!target[EFFECT_METADATA_KEY].effects.find(_ => _.propertyName === prop) && prop.startsWith(__effectKey)) {

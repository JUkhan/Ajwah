...
@Component({
    ...
    template: `
    <form (submit)="addTutorial($event)">
        <input [(ngModel)]="tutorialModel.name" type="text" name="name" placeholder="Enter Name" />
        <input [(ngModel)]="tutorialModel.url" type="text" name="url" placeholder="Enter url" />
